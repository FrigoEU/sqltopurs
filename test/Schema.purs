...
newtype Res0 = Res0 {id :: UUID, d :: Date, twotz :: DateTime, t :: Time, mt :: Maybe Time, myadt :: Maybe MyADT}
runRes0 :: Res0 -> {id :: UUID, d :: Date, twotz :: DateTime, t :: Time, mt :: Maybe Time, myadt :: Maybe MyADT}
runRes0 (Res0 a) = a
instance isSqlValueRes0 :: IsSqlValue Res0 where 
 toSql a = toSql ""
 fromSql obj = Res0 <$> ({id: _, d: _, twotz: _, t: _, mt: _, myadt: _} <$> (readSqlProp "id" obj :: F UUID) <*> (readSqlProp "d" obj :: F Date) <*> (readSqlProp "twotz" obj :: F DateTime) <*> (readSqlProp "t" obj :: F Time) <*> (readSqlProp "mt" obj :: F (Maybe Time)) <*> (readSqlProp "myadt" obj :: F (Maybe MyADT)))
...
inserttest cl {d, twotz, t, myadt, mt} = (map runRes1) <$> queryOne (Query "select * from inserttest($1,$2,$3,$4,$5)") [toSql d, toSql twotz, toSql t, toSql myadt, toSql mt] cl
